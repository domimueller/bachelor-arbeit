...
\begin{table} [H]
	...
	\begin{tabular}{ p{1cm} p{14cm} }
		...
		A4 & Das System arbeitet aus konfigurierbarer Entfernung zu den Tieren, sodass das System sicherer ist.\\				
...
\begin{table}[H]
	...
	\begin{tabular}{ p{1cm} p{14cm} }
		...
		\midrule 
		B1 & Das System reduziert den Aufwand für die manuellen Überwachung des Geburtsverlaufs. \\
